...
import com.prateek.android.connexus.handler.MyNearByImagesJsonHandler;
 ...
 *
 */
public class NearByFragment extends Fragment implements OnDownloadListenerConnexusImages {
    ...
    MyNearByImagesJsonHandler jsonHandler;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.onCreate(savedInstanceState);
        jsonHandler = new MyNearByImagesJsonHandler(this);
        MyConnexusClientUsage client = new MyConnexusClientUsage();

        if(getArguments() != null ){
            img = getArguments().getString("streamKey");
        }
        else { // default
            img = "5629499534213120";
        }
        params.put("stream", img);

        try {
//            client.getStream(jsonHandler, params, "NearByStream.json");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        gridView = (GridView) view.findViewById(R.id.grid_nearby_all);
    ...
    // TODO: MUST DO...
    public void updateSingleStreamView() {
